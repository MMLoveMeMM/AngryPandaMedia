...
static JNINativeMethod NativeWindowMethods[] =
{
    {"nativewindow", "(Ljava/lang/Object;Ljava/lang/String;)I",(void *)Java_com_panda_org_ffmpegextwrapper_FFmpegWrapper_nativewindow}
};

int register_android_jni_nativewindow_module(JNIEnv* env, jclass clazz){
        return jniRegisterNativeMethods(env, clazz, NativeWindowMethods, sizeof(NativeWindowMethods) / sizeof(NativeWindowMethods[0]));
}