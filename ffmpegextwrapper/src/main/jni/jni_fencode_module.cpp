...
static JNINativeMethod FENCODEMethods[] =
{
    {"yuvToHxxx", "(Ljava/lang/String;Ljava/lang/String;)I",(void *)Java_com_panda_org_ffmpegextwrapper_FFmpegWrapper_yuvToHxxx}
};

int register_android_jni_fencode_module(JNIEnv* env, jclass clazz){
        return jniRegisterNativeMethods(env, clazz, FENCODEMethods, sizeof(FENCODEMethods) / sizeof(FENCODEMethods[0]));
}