...
public class AudioDecoderP1 {

    private static final String TAG = "AudioDecoderP1";
    //声道数
    ...
    public AudioDecoderP1(IDumpAudio dumpAudio) {
    ...
    public void decode(byte[] buf, int offset, int length) {
        ...
        try {
            ...
            while (outputBufferIndex >= 0) {
                ...
                outputBuffer.clear();
                //播放解码后的数据
                //dumpAudio.playAudioTrack(outData, 0, info.size);
                dumpAudio.onFrame(outData, info.size);
                //释放已经解码的buffer
