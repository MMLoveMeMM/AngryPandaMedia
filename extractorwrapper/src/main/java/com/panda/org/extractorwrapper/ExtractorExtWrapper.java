...
public class ExtractorExtWrapper extends Thread {
    ...
    public void run() {
        ...
        ExtractorExt(mSrcPath, mStartPoint, mClipDuration);
        LogUtils.i("clip operation finished !");

    }

    public ExtractorExtWrapper(String path, long clipPoint, long clipDuration) {
        this.mSrcPath = path;
        this.mStartPoint = clipPoint;
    ...
    * 时间的单位 : uS (微秒)
    * */
    public boolean ExtractorExt(String url, long clipPoint, long clipDuration) {
        ...
        try {
            ...
            LogUtils.e("error path" + e.getMessage());
        }
        //获取每个轨道的信息
            ...
            try {
                ...
                if (mime.startsWith("video/")) {
                    ...
                    if (clipPoint >= videoDuration) {
                        LogUtils.e("clip point is error!");
                        return false;
                    }
                    if ((clipDuration != 0) && ((clipDuration + clipPoint) >= videoDuration)) {
                        LogUtils.e("clip duration is error!");
                        return false;
                    }
                    LogUtils.d("width and height is " + width + " " + height
                    ...
                    LogUtils.d("sampleRate is " + sampleRate
        ...
        while (true) {
            ...
            LogUtils.d("trackIndex is " + trackIndex
        ...
        //获取音频帧时长
        {
            ...
            LogUtils.d("AudioSampleTime is " + audioSampleTime);
        }
