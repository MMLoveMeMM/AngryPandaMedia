...
public class AvcDecoderP3 {

    private String TAG = "AvcDecoderP3";
    //解码后显示的surface及其宽高
     ...
     */
    public AvcDecoderP3(SurfaceHolder holder, int width, int height) {
...
//                "width = [" + width + "], height = [" + height + "]");
    ...
    public AvcDecoderP3(SurfaceHolder holder) {
